                        ...
                        <ValidationObserver ref="errors">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
                                    ...
                                    <div class="form-group row">
                                        <label for="avatar" class="col-2 col-form-label">Ảnh khuyến mãi</label>
                                        <div class="col-10">
                                            <validation-provider rules="required|length:0,255" v-slot="{ errors }">
...
export default {
    ...
    async mounted() {
        ...
        await axios('/api/promotions/' + this.$route.params.id).then(res => {
    ...
    methods: {
        ...
        async submit(status) {
            if (await this.errors()) {
                ...
                axios.post('/api/promotions', params).then((res) => {
                    KTApp.unblockPage();

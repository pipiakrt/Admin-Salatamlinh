                                ...
                                <tr v-for="item in posts.data" :key="'row' + item.id">
                                    <td class="pl-0 py-8">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <router-link :to="'/bai-viet/' + item.id + '/chinh-sua'" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg" v-text="'Trần Văn Kiên'"></router-link>
                                                <span class="text-muted d-block" v-text="'kien.tran@salagroup.vn'"></span>
                                                <span class="text-muted d-block" v-text="'Điện thoại: 0987654321'"></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg" v-text="Text(item.description, 500)"></span>
                                    </td>
                                    <td>
